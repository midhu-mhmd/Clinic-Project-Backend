...
export const resendOTP = catchAsync(async (req, res) => {
  ...
  res
    .status(200)
    .json({ success: true, message: "New security code dispatched." });
});
...
export const updateProfile = catchAsync(async (req, res) => {
  ...
  res
    .status(200)
    .json({ success: true, message: "Profile synchronized.", data: updated });
});
...
export const uploadImage = catchAsync(async (req, res) => {
  ...
  const updated = await tenantService.updateTenantImageService(
    req.user.tenantId,
    imageUrl,
  );
...
export const forgotPasswordClinic = catchAsync(async (req, res) => {
  ...
  res
    .status(200)
    .json({ success: true, message: "Reset code dispatched to email." });
});
